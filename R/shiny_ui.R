        ...
        tabItem(tabName = "fullpanel",
                fluidPage(
                  div(class = "full-panel-container",
                      ...
                      br(),
                      # Download buttons for full panel
                      div(style = "text-align: center; margin: 20px 0;",
                          downloadButton("downloadFullPNG", "Save as PNG",
                                       style = "margin-right: 10px; background-color: #007bff; color: white;"),
                          downloadButton("downloadFullPDF", "Save as PDF",
        ...
        tabItem(tabName = "umap",
                fluidPage(
                  verticalLayout(
                    ...
                    br(),
                    # Download buttons for UMAP
                    div(style = "text-align: center; margin: 20px 0;",
                        downloadButton("downloadUmapPNG", "Save as PNG",
                                     style = "margin-right: 10px; background-color: #007bff; color: white;"),
                        downloadButton("downloadUmapPDF", "Save as PDF",
                                     style = "background-color: #28a745; color: white;")
                    )
                  )
                )
        ...
        tabItem(tabName = "vlnplot",
                fluidPage(
                  verticalLayout(
                    ...
                    br(),
                    # Download buttons for Violin plot
                    div(style = "text-align: center; margin: 20px 0;",
                        downloadButton("downloadViolinPNG", "Save as PNG",
                                     style = "margin-right: 10px; background-color: #007bff; color: white;"),
                        downloadButton("downloadViolinPDF", "Save as PDF",
                                     style = "background-color: #28a745; color: white;")
                    )
                  )
                )
        ...
        tabItem(tabName = "table",
                fluidPage(
                  verticalLayout(
                    ...
                    br(),
                    # Download buttons for Table plot
                    div(style = "text-align: center; margin: 20px 0;",
                        downloadButton("downloadTablePNG", "Save as PNG",
                                     style = "margin-right: 10px; background-color: #007bff; color: white;"),
                        downloadButton("downloadTablePDF", "Save as PDF",
                                     style = "background-color: #28a745; color: white;")
                    )
                  )
                )
